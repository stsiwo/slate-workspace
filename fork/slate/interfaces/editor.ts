...
import { Drafted } from 'immer/dist/types-internal';
...
Property '[DRAFT_STATE]' is missing in type 'Range' but required in type '{ [DRAFT_STATE]: ImmerState; }'.
  ...
  /**
   * (Custom) get current element by current location
   **/
  getTextOfCurrentElement(editor: Editor): Text {
    return Editor.leaf(editor, editor.selection)[0]
  }
}
